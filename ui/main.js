...
/*        'supplier_products':{'label':'Products', 'type':'simplegrid', 'num_cols':2, 'sortable':'yes',
            ...
            'buttons':{
                ...
                'addcredit':{'label':'Add Credit', 
                    'visible':function() {return (M.ciniki_foodmarket_main.menu.data.order.payment_status > 0 
                        && M.ciniki_foodmarket_main.menu.data.order.balance_amount > 0 ?'yes':'no');},
        ...
        'procurement_supplier_inputs':{'label':'Items', 'type':'simplegrid', 'num_cols':5,
...
*/
    ...
    this.menu.cellValue = function(s, i, j, d) {
        ...
        if( s == 'checkout_tallies' || s == 'checkout_payments' ) {
            switch(j) {
    ...
    this.menu.checkoutQuantityUpdate = function(e,i,q) {
        M.api.getJSONCb('ciniki.poma.dateCheckout', 
            {'business_id':M.curBusinessID, 'date_id':this.date_id, 'order_id':this.order_id, 'item_id':i, 'new_quantity':q, 'customer_id':this.customer_id}, 
            M.ciniki_foodmarket_main.menu.processCheckout);
    }
