...
function ciniki_foodmarket_objects($ciniki) {
    ...
    $objects['product'] = array(
        ...
        'fields'=>array(
            ...
            'available_months'=>array('name'=>'Available Months', 'default'=>'0'),
            'storage'=>array('name'=>'Storage Tips', 'default'=>''),
            'culinary'=>array('name'=>'Culinary Tips', 'default'=>''),
    ...
    $objects['output'] = array(
        ...
        'fields'=>array(
            ...
            'retail_mdiscount_percent'=>array('name'=>'Member Discount', 'default'=>'0'),
            'retail_mprice'=>array('name'=>'Member Price', 'default'=>'0'),
            'retail_mprice_text'=>array('name'=>'Memeber Price Text', 'default'=>''),
