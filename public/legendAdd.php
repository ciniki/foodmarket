...
// Description
// -----------
// This method will add a new legend for the tenant.
//
// Arguments
// ---------
// api_key:
...
// <rsp stat="ok" id="42">
//
function ciniki_foodmarket_legendAdd(&$ciniki) {
    //
    ...
    $rc = ciniki_foodmarket_checkAccess($ciniki, $args['tnid'], 'ciniki.foodmarket.legendAdd');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    if( $rc['num_rows'] > 0 ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.foodmarket.4', 'msg'=>'You already have a legend with that name, please choose another.'));
    }
    ...
    //
    // Add the legend to the database
    //
    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'objectAdd');
    $rc = ciniki_core_objectAdd($ciniki, $args['tnid'], 'ciniki.foodmarket.legend', $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
    ...
    return array('stat'=>'ok', 'id'=>$legend_id);
}
?>
