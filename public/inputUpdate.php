...
function ciniki_foodmarket_inputUpdate(&$ciniki) {
    ...
    $rc = ciniki_foodmarket_checkAccess($ciniki, $args['business_id'], 'ciniki.foodmarket.inputUpdate');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['business_id'], 'ciniki.foodmarket.input', $args['input_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
    ...
    $rc = ciniki_foodmarket_productUpdateFields($ciniki, $args['business_id'], $input['product_id']);
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_foodmarket_productPricePush($ciniki, $args['business_id'], $input['product_id']);
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
