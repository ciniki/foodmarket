...
function ciniki_foodmarket_categoryHistory($ciniki) {
    ...
    $rc = ciniki_foodmarket_checkAccess($ciniki, $args['tnid'], 'ciniki.foodmarket.categoryHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.foodmarket', 'ciniki_foodmarket_history', $args['tnid'], 'ciniki_foodmarket_categories', $args['category_id'], $args['field']);
}
?>
