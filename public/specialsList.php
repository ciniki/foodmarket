...
function ciniki_foodmarket_specialsList($ciniki) {
    ...
    if( isset($args['output_id']) && $args['output_id'] > 0 && isset($args['retail_sdiscount_percent']) && $args['retail_sdiscount_percent'] != '' ) {
        ...
        if( $output['retail_sdiscount_percent'] != $args['retail_sdiscount_percent'] ) {
            ...
            $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.foodmarket.output', $args['output_id'], array('retail_sdiscount_percent'=>$args['retail_sdiscount_percent']), 0x04);
            if( $rc['stat'] != 'ok' ) {
            ...
            $rc = ciniki_foodmarket_productUpdateFields($ciniki, $args['tnid'], $output['product_id']);
            if( $rc['stat'] != 'ok' ) {
                return $rc;
            }
            ...
            $rc = ciniki_foodmarket_productPricePush($ciniki, $args['tnid'], $output['product_id']);
            if( $rc['stat'] != 'ok' ) {
                return $rc;
            }
