...
function ciniki_foodmarket_categoryUpdate(&$ciniki) {
    ...
    $rc = ciniki_foodmarket_checkAccess($ciniki, $args['tnid'], 'ciniki.foodmarket.categoryUpdate');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.foodmarket.category', $args['category_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
