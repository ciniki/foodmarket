...
// Description
// -----------
// This method searchs for a Seasons for a tenant.
//
// Arguments
// ---------
// api_key:
...
// -------
//
function ciniki_foodmarket_seasonSearch($ciniki) {
    //
    ...
    $rc = ciniki_foodmarket_checkAccess($ciniki, $args['tnid'], 'ciniki.foodmarket.seasonSearch');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
