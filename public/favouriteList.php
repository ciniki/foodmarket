...
// -------
//
function ciniki_foodmarket_favouriteList($ciniki) {
    //
    ...
    $rc = ciniki_foodmarket_checkAccess($ciniki, $args['tnid'], 'ciniki.foodmarket.favouriteList');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    if( isset($args['customer_id']) && $args['customer_id'] > 0 ) {
        $strsql = "SELECT ciniki_poma_customer_items.id, "
            ...
            . "LEFT JOIN ciniki_poma_order_items ON ("
                ...
                . "AND ciniki_poma_customer_items.object = ciniki_poma_order_items.object "
