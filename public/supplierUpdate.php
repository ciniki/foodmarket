...
function ciniki_foodmarket_supplierUpdate(&$ciniki) {
    ...
    $rc = ciniki_foodmarket_checkAccess($ciniki, $args['tnid'], 'ciniki.foodmarket.supplierUpdate');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.foodmarket.supplier', $args['supplier_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
