...
function ciniki_foodmarket_slideshowDelete(&$ciniki) {
    ...
    $rc = ciniki_foodmarket_checkAccess($ciniki, $args['tnid'], 'ciniki.foodmarket.slideshowDelete');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectCheckUsed($ciniki, $args['tnid'], 'ciniki.foodmarket.slideshow', $args['slideshow_id']);
    if( $rc['stat'] != 'ok' ) {
    ...
    //
    $rc = ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.foodmarket.slideshow',
